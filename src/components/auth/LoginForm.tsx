  ...
  return (
    <div className="w-full max-w-md space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1 text-sm">Sign in to your {' '}
          <Link href="/" className="text-indigo-400">GameVault</Link> account
        </p>
      </div>

      <button
        onClick={handleGoogle}
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-[#1a1d2e] border border-white/10 rounded-lg text-sm text-gray-300 hover:text-white hover:border-white/20 transition-colors"
      >
